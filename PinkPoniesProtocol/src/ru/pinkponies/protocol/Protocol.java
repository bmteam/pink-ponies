...
public final class Protocol {
	...
	public void pack(Packet packet, ByteBuffer buffer) throws IOException, BufferOverflowException {
		if (packet == null) {
			throw new NullPointerException("Packet can not be null.");
		}
	...
	public Packet unpack(ByteBuffer buffer) throws IOException {
		// FIXME(alexknvl): wtf, there is no way to read directly from ByteBuffer?
		BufferUnpacker unpacker = messagePack.createBufferUnpacker(buffer.array());
