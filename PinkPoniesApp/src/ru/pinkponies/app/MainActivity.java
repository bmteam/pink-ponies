	...
	public void onMessage(final Object message) {
		...
		if (message.equals("failed")) {
			...
			if (this.myId != BAD_ID && packet.clientId != this.myId) {
				final LatLng location = new LatLng(packet.location.latitude, packet.location.longitude);
			...
			if (packet.getStatus()) {
				final LatLng location = new LatLng(packet.getLocation().latitude, packet.getLocation().longitude);
				;
